...
function DraggableFloatingButtonResponsive({
  ...
  useEffect(() => {
    const updateWindowSize = () => {
      ...
      // Si hay una posición guardada, verificar que siga siendo válida
      if (savedPosition) {
        const validatedPosition = validateAndFixPosition(
          savedPosition,
          newSize
        );
        if (validatedPosition !== savedPosition) {
  ...
  }, [savedPosition, validateAndFixPosition]);
